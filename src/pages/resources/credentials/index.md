...
### Name
A CardSavr user **must** have a unique name or label.  This the identity of the person or application agent using the CardSavr platform.
...
The CardSavr API provides fine-grained control of storing Payment Credentials within the CardSavr platform to meet the storage policies of integration partners.
...
Merchant sites may challenge the cardholder user for an additional artifact to be used in conjunction with the password 
...
The API also provides fine-grained control of storing Merchant Credentials within the CardSavr platform to meet 
